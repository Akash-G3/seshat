...
// /** Layout-only shell. It deliberately knows nothing about notes or backend data. */
// export function WorkspaceShell({ activityBar, library, header, content }: WorkspaceShellProps) {
//   return (
